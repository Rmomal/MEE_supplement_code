...
The EMtree R package is available on gitHub (https://github.com/Rmomal/EMtree). The tolerance is lower for hard cases, as numerical artifacts tend to appear more often there. 

```{r}
library(EMtree) 
cond.tol<-switch(difficulty,"easy"=1e-12,"hard"=1e-6) 
resample<-ResampleEMtree(counts=Y, covar_matrix=m, S=20, maxIter=200,
...
EMtree_prob<-EMtree(PLN_Y)$edges_prob
```